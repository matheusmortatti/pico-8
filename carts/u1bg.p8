...
function _draw()
  ...
  if debug then
    ...
    print("fps: " .. stat(7) .. " mem: " .. flr(stat(0)) .. " cpu: " .. stat(1),2,2,8)
  end
...
function door:render()
  ...
  print(tostr(#self.btn-self.p), x,y,7)
end
...
function button:pressed()
  if self.t==0 then
    for i=1,3 do
      p_add(smoke({
        pos=v(self.pos.x+rnd(8),self.pos.y+6+rnd(2)),
        c=rnd(1)<0.5 and 7 or 6
      }))
    end
    shake=3
  end
...
10770701107777071077070177777777110770117007700700000000100000011111111110099001707007070007007007007000107007010000000000000000
...

...

...
__gff__

...

...


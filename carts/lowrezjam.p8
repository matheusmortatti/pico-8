...
function enemy:dead()
  ...
  if  self.t == ceil(self.death_time/2) then
    ...
    drop_entity(ceil(self.coindrop*level_params[current_level].hm),self.pos.x+midx,self.pos.y,coin)
...
function ptext:render()
  ...
  local dirs={v(1,1),v(-1,-1),v(1,-1),v(-1,1)}

  for d in all(dirs) do
    print(self.txt,self.pos.x+d.x,self.pos.y+d.y,0)
  end
...
level_params = {[1]={sx=3,sy=3,pe=0.3,pl=0.2,hm=1},
                ...
                [10]={sx=9,sy=7,pe=0.3,pl=0.7,hm=2.2}}
...
function draw_title()
  ...
  for d in all(dirs) do
    print(msg1, 32 - (#msg1/2)*4+d.x,16+d.y,0)
    print(msg2, 32 - (#msg2/2)*4+d.x,44+d.y,0)
  end
  print(msg1, 32 - (#msg1/2)*4,16,13)

  print(msg2, 32 - (#msg2/2)*4,44,13)
  palt()
end
...

...

